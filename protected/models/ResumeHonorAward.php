...
/**
 * This is the model class for table "resume_honor_award".
 *
 * The followings are the available columns in table 'resume_honor_award':
 * @property string $id
 ...
 */
class ResumeHonorAward extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'resume_honor_award';
    }
     ...
     * @return ResumeHonorAward the static model class
     */
    ...
    public function delete_item($id, $resume_id) {
        ...
        $sql = 'DELETE FROM resume_honor_award WHERE id = ' . (int) $id . ' AND resume_id = ' . (int) $resume_id . ' AND user_id = ' . Yii::app()->user->id;
