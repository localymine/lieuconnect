 ...
 *
 * The followings are the available columns in table 'resume_skill':
 * @property string $id
 ...
 */
class ResumeSkill extends CActiveRecord {
     ...
     * @return ResumeSkill the static model class
     */
    ...
    public function delete_item($id, $resume_id) {
        ...
        $sql = 'DELETE FROM resume_skill WHERE id = ' . (int) $id . ' AND resume_id = ' . (int) $resume_id . ' AND user_id = ' . Yii::app()->user->id;
