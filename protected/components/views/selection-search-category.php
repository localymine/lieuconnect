<select id="<?php echo $id ?>" name="<?php echo $submit_name ?>" class="form-control <?php echo $this->class ?>" size="1" <?php if ($submit_form != '') echo " form='$submit_form'" ?> <?php if ($this->onChange != '') echo " onchange='$this->onChange'" ?> >
    <?php if ($this->update == TRUE):?>
    <option value="-1">None</option>
    <option value="0">Root</option>
    <?php else: ?>
    <option value="-1"><?php echo $this->empty ?></option>
    <?php endif; ?>
<?php
$level = 0;
