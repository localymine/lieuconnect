...
$this->pageTitle = ($update == 0) ? ("Add Stories" . ' | ' . Yii::app()->name) : ("Update Stories" . ' | ' . Yii::app()->name);
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>Stories<br /><small>...</small>
        </h1>
    </div>
</div>
    ...
    <div class="col-md-8">
        <div class="block">
            <div class="block-title">
                ...
                <?php if($update == 1): ?>
                <div class="block-options pull-right"><a href="<?php echo Yii::app()->createUrl('backend/post/addStory') ?>" class="btn btn-sm btn-primary">Add New</a></div>
                <?php endif; ?>
            </div>
                ...
                <div class="tab-content">
                    ...
                    foreach (Yii::app()->params['translatedLanguages'] as $l => $lang):
                        ...
                        <div class="tab-pane fade in <?php echo $active ?>" id="<?php echo $lang; ?>">
                            ...
                            <!--
                            <div class="form-group">
                                <label class="control-label col-md-offset-2">Quote Author</label>
                                <div class="col-md-12">
                                    <?php // echo $form->textField($model, 'quote_author' . $suffix, array('class' => 'form-control')) ?>
                                </div>
                            </div>
                            -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">This content will showed on the main page</div>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="help-block">Please upload with the image size: 287 x 287</div>
                                <div class="col-xs-9">
                                    <?php
            ...
            <div class="form-group">
                <div class="lst_category auto">
                    ...
                    $this->widget('TreeFilter', array(
                        ...
                        'submit_name' => 'Post[post_group][]',
                        'select' => $select_post_group,
                        'filter' => 'story-group',
                        'multi_select' => false,
                    )) 
                    ?>
