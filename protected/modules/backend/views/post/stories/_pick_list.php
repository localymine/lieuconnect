<?php foreach ($posts as $row): ?>
    ...
    <li data-postid="<?php echo $row->post->id ?>" class="ui-draggable" style="display: inline-block; width: 70px;">
        ...
        <div class="hold-img-news" style="width: 68px; height: 70px;">
            <img width="126" align="left" src="/lilely/images/story/<?php echo $row->post->image ?>" style="padding: 5px; width: 70px;" class="img-news">
        </div>
        ...
        <a title="Edit" class="ui-icon-edit pull-left pl10" href="<?php echo Yii::app()->createUrl('backend/post/updateStory/' . $row->post->id) ?>"><i class="fa fa-pencil"></i></a>
