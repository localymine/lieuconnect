...
$this->pageTitle = "Our Picks Scholarship" . ' | ' . Yii::app()->name;
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>Pick Scholarship<br />
    ...
    <div class="col-md-12">
        <div class="block">
            ...
            <div id="ourpicks" class="form-group">
                <ul id="sortable" class="gallery ui-helper-reset">
                    <?php if ($our_picks != '') $this->renderPartial('scholarship/_pick_list', array('posts' => $our_picks), false); ?>
                </ul>
            </div>
        </div>
        ...
        <div class="block">
            <div class="block-title">
                <h2>List Scholarships</h2><div class="block-options pull-right"></div>
            </div>
            ...
            <div class="">
                <ul id="gallery" class="gallery ui-helper-reset">
                    <?php if ($list != ''): ?>
                        <?php echo $list ?>
                    <?php else: ?>
                        <?php $this->renderPartial('scholarship/_list', array('posts' => $posts), false); ?>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    $(function() {
        ...
        $('#update-pick').click(function(e) {
            ...
            if (data.length === 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo Yii::app()->createUrl("backend/post/updatePickScholarship"); ?>',
...
/*
        $("#jpagination").paginate({
            ...
            onChange: function(page){
                var href = '<?php // echo Yii::app()->createUrl('backend/post/pickScholarship?page=') ?>' + page;
                $('body').append(ajaxloader);
