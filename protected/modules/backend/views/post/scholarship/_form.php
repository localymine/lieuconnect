...
$this->pageTitle = ($update == 0) ? ("Add Scholarship" . ' | ' . Yii::app()->name) : ("Update Scholarship" . ' | ' . Yii::app()->name);
...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-brush"></i>Scholarship<br /><small>...</small>
        </h1>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="block">
            <div class="block-title">
                ...
                <?php if ($update == 1): ?>
                    <div class="block-options pull-right"><a href="<?php echo Yii::app()->createUrl('backend/post/addScholarship') ?>" class="btn btn-sm btn-primary">Add New</a></div>
                <?php endif; ?>
            </div>
                        ...
                        <div class="tab-pane fade in <?php echo $active ?>" id="<?php echo $lang; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <span class="input-group-addon"><img width="24" src="<?php echo Yii::app()->baseUrl ?>/images/flags/<?php echo $l ?>.png"/></span>
                                        <?php echo $form->textField($model, 'slug' . $suffix, array('class' => 'form-control', 'form' => 'scholarship-form', 'id' => 'slug-' . $lang)) ?>
    ...
    <div class="col-md-4">
        ...
        <div class="block form-horizontal clearfix">
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        <input type="file" id="Post_school_logo" name="Post[school_logo]" class="" form="scholarship-form">
        ...
        <div class="block clearfix">
            <div class="block-title">
                <h2>Deadline for Scholarship</h2>
            </div>
            <div class="form-group">
                <?php echo $form->textField($model, 'deadline', array('class' => 'form-control input-datepicker', 'data-date-format' => 'yyyy-mm-dd', 'placeholder' => 'yyyy-mm-dd', 'form' => 'scholarship-form')) ?>
                <span class="help-block">Input with format (yyyy-mm-dd)</span>
            </div>
            <div class="form-group">
                <?php echo $form->dropDownList($model, 'deadline_string', Post::item_alias('deadline'), array('class' => 'form-control', 'form' => 'scholarship-form', 'empty' => 'None')) ?>
            </div>
        </div>
...
<?php echo CHtml::submitButton($model->isNewRecord ? 'Add New' : 'Update', array('class' => 'btn btn-sm btn-primary', 'form' => 'scholarship-form')); ?>
                    <button class="btn btn-sm btn-warning" type="reset" form="scholarship-form"><i class="fa fa-repeat"></i> Reset</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#tags_form').textext({
        ...
        prompt: 'add a tag ...',
        html: {hidden: '<input id="Post_tags" name="Post[tags]" type="hidden" form="scholarship-form" />'},
