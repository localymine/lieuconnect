    ...
    <div class="tab-content">
        <div class="tab-pane active" id="high">
            ...
            $form_high_school = $this->beginWidget('CActiveForm', array(
                'id' => 'search-form',
                'method' => 'get',
                'action' => Yii::app()->createUrl('search/scholarship'),
                'htmlOptions' => array(
                )
            ));
            ?>
            <div class="row">
                <div class="col-md-10 no-padding">
                    <?php echo CHtml::textField('k', (isset($keyword) ? $keyword : ''), array('placeholder' => Common::t('Scholarship name or keyword...', 'post'), 'class' => 'form-control')) ?>
                </div>
