...
$share_url = Yii::app()->createUrl(Yii::app()->params['siteUrl'] . '/internship/show', array('slug' => $post->slug));
$title = $post->post_title;
$image_url = Yii::app()->params['siteUrl'] . '/images/internship/' . $image_entry;
    ...
    <div class="main scholarship-result">
        <div class="content-col col-md-8 col-sm-12 col-xs-12 no-padding ">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9 no-padding result-detail">
                ...
                <div class="content">
                    <!--<p><img src="<?php // echo Yii::app()->baseUrl ?>/images/internship/<?php // echo $image_entry ?>" class="img-responsive" /></p>-->
                    <?php echo $post->post_content ?>
                </div>
                <p><span class="jobtitle"><?php echo Common::t('Job title', 'post') ?>: </span><?php echo $post->job_title ?></p>
                <p><span class="position"><?php echo Common::t('Job title', 'post') ?>: </span><?php echo $post->position ?></p>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12 no-padding our-picks-frame">
            <div class="ourPicks">
                ...
                <?php foreach ($model_our_picks as $row): ?>
                    ...
                    <p>
                        <a href="<?php echo Yii::app()->createUrl('internship/show', array('slug' => $row->post->slug)) ?>">
                        <img src="<?php echo Yii::app()->baseUrl ?>/images/internship/<?php echo $row->post->image ?>" class="img-responsive">
